...
import vn.edu.hust.airplanecontext.domain.factory.airplane.eventproduct.AirplaneTakenOffEventProduct;
import vn.edu.hust.airplanecontext.domain.message.command.airplane.TakeOffAirplaneCommand;
